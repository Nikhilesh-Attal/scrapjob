...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyA1iMR1AMNtNVE4W28SeyEOe8ZwEpYUDqk"),
    authDomain: ("TURBOPACK compile-time value", "snapjob-62654.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "snapjob-62654"),
    storageBucket: ("TURBOPACK compile-time value", "snapjob-62654.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "165428972371"),
    appId: ("TURBOPACK compile-time value", "1:165428972371:web:0fed5c63fad777a626efa6"),
    measurementId: ("TURBOPACK compile-time value", "G-12Z9QFF27M")
};
// Initialize Firebase
                ...
                "AuthProvider.useEffect.unsubscribe": async (currentUser)=>{
                    ...
                    if (currentUser) {
                        ...
                        if (userDoc.exists()) {
                            ...
                            setUserData({
                                ...newUserDoc,
                                createdAt: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Timestamp"](new Date().getTime() / 1000, 0)
                            });
                        }
                    } else {
                        setUser(null);
